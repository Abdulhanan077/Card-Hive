...
import { getUnreadUserNotifications } from "@/app/actions/user-notifications";
                ...
                <div className="notification-dropdown">
                    ...
                    <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
                        {notifications.length === 0 ? (
                            ...
                            notifications.map((notif) => (
                                <Link
                                    key={notif.id}
                                    href={`/user/trades/${notif.trade.tradeId}`}
                    ...
                    {notifications.length > 0 && (
                        <div style={{ padding: '0.75rem', textAlign: 'center', borderTop: '1px solid var(--border)' }}>
                            <Link href="/user/trades" style={{ fontSize: '0.8rem', color: 'var(--primary)', textDecoration: 'none' }}>
                                View all trades
                            </Link>
                        </div>
                    )}
