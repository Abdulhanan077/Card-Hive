...
class AuthService {
  ...
  Future<void> logout() async {
    ...
    // We keep 'saved_username', 'saved_password', and 'biometrics_enabled'
    // so the user can still use biometric login after a manual logout.
    // However, we disable 'remember_me' to prevent immediate auto-login on app restart.
    await _writeSecure('remember_me', 'false');
  }
